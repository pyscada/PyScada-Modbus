...
class ModbusDevice(models.Model):
    ...
    framer = models.PositiveSmallIntegerField(
        null=True, blank=True, choices=framer_choices
    )
...
class ModbusVariable(models.Model):
    ...
    function_code_read = models.PositiveSmallIntegerField(
        default=0, choices=function_code_read_choices, help_text=""
    )
